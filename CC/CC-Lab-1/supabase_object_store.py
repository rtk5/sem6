...
SUPABASE_URL = "https://eqpljvtgaogsbxqmmres.supabase.co" # Replace with your Supabase URL
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVxcGxqdnRnYW9nc2J4cW1tcmVzIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2ODI4ODcwNywiZXhwIjoyMDgzODY0NzA3fQ.0azbrjXG-kt3U0J1nuMEX_MJPkzn-M0l4p5d61H_42c" # Replace with your Supabase API key

supabase: Client = create_client(SUPABASE_URL, SUPABASE_KEY)

bucket_name = "image1" # Name of the bucket to be created
image_path = "PES2UG23CS485.jpeg"  # Replace with the local image path
image_name = "PES2UG23CS485.jpeg"  # Desired name for the uploaded file
